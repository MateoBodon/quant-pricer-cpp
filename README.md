...
> **Release status — v0.3.7.** Build from source or use the signed-off GitHub
...
The public v0.3.7 surface includes analytic European calls and puts,
...
- **SSVI is not a v0.3.7 public API.** Newer research exists outside this public
...
The latest public release is [v0.3.7](https://github.com/MateoBodon/quant-pricer-cpp/releases/tag/v0.3.7),
