...
| scripts.data.cboe_csv | `scripts/data/cboe_csv.py` | 5 | 0 | data_ingest |
| scripts.data.wrds_fetch_options | `scripts/data/wrds_fetch_options.py` | 1 | 0 | data_ingest |
| scripts.data.wrds_fetch_returns | `scripts/data/wrds_fetch_returns.py` | 3 | 0 | data_ingest |
| scripts.generate_bench_artifacts | `scripts/generate_bench_artifacts.py` | 10 | 0 | script |
| scripts.generate_metrics_summary | `scripts/generate_metrics_summary.py` | 17 | 0 | script |
...
| scripts.manifest_utils | `scripts/manifest_utils.py` | 13 | 0 | script |
...
| wrds_pipeline.ingest_sppx_surface | `wrds_pipeline/ingest_sppx_surface.py` | 11 | 0 | wrds_pipeline |
| wrds_pipeline.oos_pricing | `wrds_pipeline/oos_pricing.py` | 2 | 0 | wrds_pipeline |
| wrds_pipeline.pipeline | `wrds_pipeline/pipeline.py` | 10 | 0 | wrds_pipeline |
...
- `wrds_pipeline/calibrate_heston.py` / `calibrate_bs.py` — model calibration utilities.
...
- `scripts/qmc_vs_prng_equal_time.py`, `scripts/pde_order_slope.py`, `scripts/tri_engine_agreement.py` — key validation/benchmark figures.
