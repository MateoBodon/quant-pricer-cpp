...
static const double kGL32_x[32] = {
    0.044489365833267285, 0.23452610951961964, 0.5768846293018867, 1.072448753817818,  1.7224087764446454,
    2.5283367064257942,   3.492213273021994,   4.616456769749767,  5.903958504174244,  7.358126733186241,
    8.982940924212595,    10.783018632539973,  12.763697986742725, 14.931139755522558, 17.292454336715313,
    19.855860940336054,   22.630889013196775,  25.628636022459247, 28.862101816323474, 32.346629153964734,
    36.10049480575197,    40.14571977153944,   44.50920799575494,  49.22439498730864,  54.33372133339691,
    59.89250916213402,    65.97537728793505,   72.68762809066271,  80.18744697791352,  88.7353404178924,
    98.82954286828397,    111.7513980979377};
...
double put_analytic(const MarketParams& mkt, const Params& h) {
    return call_analytic(mkt, h) - mkt.spot * std::exp(-mkt.dividend * mkt.time) +
           mkt.strike * std::exp(-mkt.rate * mkt.time);
}
