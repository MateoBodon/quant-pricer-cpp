...
TEST(AmericanFast, PsorMatchesBinomial) {
    american::Params base{.spot = 100.0,
                          .strike = 100.0,
                          .rate = 0.05,
                          .dividend = 0.02,
                          .vol = 0.25,
    ...
    american::PsorParams psor{.base = base,
...
TEST(AmericanFast, LsmcConsistentWithPsorSmallGrid) {
    american::Params base{.spot = 95.0,
                          .strike = 100.0,
                          .rate = 0.035,
                          .dividend = 0.01,
                          .vol = 0.22,
    ...
    american::LsmcParams lsmc{.base = base,
                              .num_paths = 8000,
                              .seed = 20251030ULL,
                              .num_steps = 40,
                              .antithetic = true,
...
TEST(AmericanSlow, LsmcMatchesPsorWithinSe) {
    american::Params base{.spot = 90.0,
                          .strike = 100.0,
                          .rate = 0.03,
                          .dividend = 0.01,
                          .vol = 0.2,
